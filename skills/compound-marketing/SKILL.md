...
**Brief → Draft → Execute → Analyse → Optimise → Compound** — BDEAO, plus the Compound stage this skill adds on top. Six stages, one non-negotiable: the last one.
